...
namespace SimpleModelsAndRelations.Data
{
  public static class SimpleModelsAndRelationsContextSeeds
  {
    ...
    static Ninety[] Nineties = null;
     static Action seed_Recommendations = null;
    static Recommendation[] Recommendations = null;
    ...
    public static void InitializePagesAndSingletons(SimpleModelsAndRelationsContext context) {
      ...
      if (!context.Recommendation.Any()) {
        var root = new Recommendation() { CreatedDate = DateTime.Now,  };
        Recommendations = new [] {root};
        context.Recommendation.Add(root);
        context.SaveChanges();
      } else {
        Recommendations = context.Recommendation.ToArray();
      }
    ...
    public static void Initialize(SimpleModelsAndRelationsContext context)
    {
      ...
      seed_Homepages = () => {
        ...
        if (!context.Homepage.Any())
        {
          var _Homepage = new System.Collections.Generic.List<Homepage>();
            ...
            _Homepage.Add(new Homepage { Id = 1, CreatedDate = DateTime.Now,   });
      ...
      seed_Recommendations = () => {
        ...
        if (!context.Recommendation.Any())
        {
          var _Recommendation = new System.Collections.Generic.List<Recommendation>();
          
          
            
            _Recommendation.Add(new Recommendation { Id = 1, CreatedDate = DateTime.Now,   });

          foreach (var x in _Recommendation)
          {
            context.Recommendation.Add(x);
          }
          context.SaveChanges();
        }
        Recommendations = context.Recommendation.ToArray();
      ...
      seed_Ratings = () => {
        ...
        if (!context.Rating.Any())
        {
          var _Rating = new System.Collections.Generic.List<Rating>();
            ...
            _Rating.Add(new Rating { CreatedDate = DateTime.Now, Number = 61,   });

            
            _Rating.Add(new Rating { CreatedDate = DateTime.Now, Number = -64,   });

            
            _Rating.Add(new Rating { CreatedDate = DateTime.Now, Number = 96,   });

            
            _Rating.Add(new Rating { CreatedDate = DateTime.Now, Number = -74,   });

            
            _Rating.Add(new Rating { CreatedDate = DateTime.Now, Number = 82,   });

            
            _Rating.Add(new Rating { CreatedDate = DateTime.Now, Number = 12,   });

            
            _Rating.Add(new Rating { CreatedDate = DateTime.Now, Number = 9,   });
      ...
      if (!context.Meal_Recipe.Any())
      {
        var _Meal_Recipe = new Meal_Recipe[]
        {
            ...
            new Meal_Recipe { MealId = 4, RecipeId = 5 },
            ...
            new Meal_Recipe { MealId = 1, RecipeId = 7 },

            new Meal_Recipe { MealId = 4, RecipeId = 8 },

            new Meal_Recipe { MealId = 2, RecipeId = 9 },

            new Meal_Recipe { MealId = 2, RecipeId = 10 },
      ...
      if (!context.PreparationTime_Recipe.Any())
      {
        var _PreparationTime_Recipe = new PreparationTime_Recipe[]
        {
            ...
            new PreparationTime_Recipe { PreparationTimeId = 2, RecipeId = 5 },

            new PreparationTime_Recipe { PreparationTimeId = 3, RecipeId = 6 },

            new PreparationTime_Recipe { PreparationTimeId = 2, RecipeId = 7 },

            new PreparationTime_Recipe { PreparationTimeId = 2, RecipeId = 8 },

            new PreparationTime_Recipe { PreparationTimeId = 1, RecipeId = 9 },

            new PreparationTime_Recipe { PreparationTimeId = 3, RecipeId = 10 },
      ...
      if (!context.Cuisine_Recipe.Any())
      {
        var _Cuisine_Recipe = new Cuisine_Recipe[]
        {
            
            new Cuisine_Recipe { CuisineId = 3, RecipeId = 1 },

            new Cuisine_Recipe { CuisineId = 3, RecipeId = 2 },

            new Cuisine_Recipe { CuisineId = 2, RecipeId = 3 },

            new Cuisine_Recipe { CuisineId = 1, RecipeId = 4 },

            new Cuisine_Recipe { CuisineId = 1, RecipeId = 5 },

            new Cuisine_Recipe { CuisineId = 2, RecipeId = 6 },

            new Cuisine_Recipe { CuisineId = 2, RecipeId = 7 },

            new Cuisine_Recipe { CuisineId = 1, RecipeId = 8 },

            new Cuisine_Recipe { CuisineId = 2, RecipeId = 9 },

            new Cuisine_Recipe { CuisineId = 3, RecipeId = 10 },

        };
        foreach (var x in _Cuisine_Recipe)
        {
          context.Cuisine_Recipe.Add(x);
        }
        context.SaveChanges();
      }
      var Cuisine_Recipe = context.Cuisine_Recipe.ToArray();
