...
using System.IO;
  ...
  public class DinnerApiController : Controller
  {
    ...
    public ItemWithEditable<Dinner> GetById(int id)
    {
      ...
      var item = SimpleModelsAndRelations.Models.Dinner.FilterViewableAttributesLocal()(allowed_items.FirstOrDefault(e => e.Id == id));
    ...
    public Dinner Create()
    {
      ...
      _context.Dinner.Add(SimpleModelsAndRelations.Models.Dinner.FilterViewableAttributesLocal()(item));
    ...
    public Page<Dinner> GetAll([FromQuery] int page_index, [FromQuery] int page_size = 25)
    {
      ...
      return allowed_items
        .Select(SimpleModelsAndRelations.Models.Dinner.FilterViewableAttributes())
