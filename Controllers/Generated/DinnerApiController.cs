...
using System.IO;
  ...
  public class DinnerApiController : Controller
  {
    ...
    public DinnerApiController(SimpleModelsAndRelationsContext context, IHostingEnvironment env, IOptions<MailOptions> mailOptionsAccessor)
    {
      _context = context;
    ...
    public IActionResult /*ItemWithEditable<Dinner>*/ GetById(int id)
    {
      ...
      var item = SimpleModelsAndRelations.Models.Dinner.FilterViewableAttributesLocal(current_User)(item_full);
    ...
    public Page<Dinner> GetAll([FromQuery] int page_index, [FromQuery] int page_size = 25 )
    {
      ...
      return items
        ...
        .Paginate(can_create_by_token, can_delete_by_token, false, page_index, page_size, SimpleModelsAndRelations.Models.Dinner.WithoutImages, item => item , null );
    }
