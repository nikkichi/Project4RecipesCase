...
using System.IO;
  ...
  public class BreakfastApiController : Controller
  {
    ...
    public BreakfastApiController(SimpleModelsAndRelationsContext context, IHostingEnvironment env, IOptions<MailOptions> mailOptionsAccessor)
    {
      _context = context;
    ...
    public IActionResult /*ItemWithEditable<Breakfast>*/ GetById(int id)
    {
      ...
      var item = SimpleModelsAndRelations.Models.Breakfast.FilterViewableAttributesLocal(current_User)(item_full);
    ...
    public Page<Breakfast> GetAll([FromQuery] int page_index, [FromQuery] int page_size = 25 )
    {
      ...
      return items
        ...
        .Paginate(can_create_by_token, can_delete_by_token, false, page_index, page_size, SimpleModelsAndRelations.Models.Breakfast.WithoutImages, item => item , null );
    }
