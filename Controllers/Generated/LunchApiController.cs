...
using System.IO;
  ...
  public class LunchApiController : Controller
  {
    ...
    public LunchApiController(SimpleModelsAndRelationsContext context, IHostingEnvironment env, IOptions<MailOptions> mailOptionsAccessor)
    {
      _context = context;
    ...
    public IActionResult /*ItemWithEditable<Lunch>*/ GetById(int id)
    {
      ...
      var item = SimpleModelsAndRelations.Models.Lunch.FilterViewableAttributesLocal(current_User)(item_full);
    ...
    public Page<Lunch> GetAll([FromQuery] int page_index, [FromQuery] int page_size = 25 )
    {
      ...
      return items
        ...
        .Paginate(can_create_by_token, can_delete_by_token, false, page_index, page_size, SimpleModelsAndRelations.Models.Lunch.WithoutImages, item => item , null );
    }
