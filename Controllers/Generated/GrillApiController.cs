...
using System.IO;
  ...
  public class GrillApiController : Controller
  {
    ...
    public ItemWithEditable<Grill> GetById(int id)
    {
      ...
      var item = SimpleModelsAndRelations.Models.Grill.FilterViewableAttributesLocal()(allowed_items.FirstOrDefault(e => e.Id == id));
    ...
    public Grill Create()
    {
      ...
      _context.Grill.Add(SimpleModelsAndRelations.Models.Grill.FilterViewableAttributesLocal()(item));
    ...
    public Page<Grill> GetAll([FromQuery] int page_index, [FromQuery] int page_size = 25)
    {
      ...
      return allowed_items
        .Select(SimpleModelsAndRelations.Models.Grill.FilterViewableAttributes())
