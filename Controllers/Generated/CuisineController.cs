...
[Route("/[controller]")]
  public class CuisinesController : Controller
  {
    ...
    public CuisinesController(SimpleModelsAndRelationsContext context, IHostingEnvironment env, IOptions<MailOptions> mailOptionsAccessor)
    {
      _context = context;
