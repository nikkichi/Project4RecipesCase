...
[Route("/[controller]")]
  public class BrowsesController : Controller
  {
    ...
    public BrowsesController(SimpleModelsAndRelationsContext context, IHostingEnvironment env, IOptions<MailOptions> mailOptionsAccessor)
    {
      _context = context;
