...
using System.IO;
  ...
  public class PreparationTimeApiController : Controller
  {
    ...
    public ItemWithEditable<PreparationTime> GetById(int id)
    {
      ...
      var item = SimpleModelsAndRelations.Models.PreparationTime.FilterViewableAttributesLocal()(allowed_items.FirstOrDefault(e => e.Id == id));
    ...
    public PreparationTime Create()
    {
      ...
      _context.PreparationTime.Add(SimpleModelsAndRelations.Models.PreparationTime.FilterViewableAttributesLocal()(item));
    ...
    public Page<PreparationTime> GetAll([FromQuery] int page_index, [FromQuery] int page_size = 25)
    {
      ...
      return allowed_items
        .Select(SimpleModelsAndRelations.Models.PreparationTime.FilterViewableAttributes())
