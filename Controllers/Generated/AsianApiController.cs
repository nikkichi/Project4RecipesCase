...
using System.IO;
  ...
  public class AsianApiController : Controller
  {
    ...
    public AsianApiController(SimpleModelsAndRelationsContext context, IHostingEnvironment env, IOptions<MailOptions> mailOptionsAccessor)
    {
      _context = context;
    ...
    public IActionResult /*ItemWithEditable<Asian>*/ GetById(int id)
    {
      ...
      var item = SimpleModelsAndRelations.Models.Asian.FilterViewableAttributesLocal(current_User)(item_full);
    ...
    public Page<Asian> GetAll([FromQuery] int page_index, [FromQuery] int page_size = 25 )
    {
      ...
      return items
        ...
        .Paginate(can_create_by_token, can_delete_by_token, false, page_index, page_size, SimpleModelsAndRelations.Models.Asian.WithoutImages, item => item , null );
    }
