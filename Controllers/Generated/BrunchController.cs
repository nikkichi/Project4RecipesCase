...
[Route("/[controller]")]
  public class BrunchesController : Controller
  {
    ...
    public BrunchesController(SimpleModelsAndRelationsContext context, IHostingEnvironment env, IOptions<MailOptions> mailOptionsAccessor)
    {
      _context = context;
