...
[Route("/[controller]")]
  public class RecommendationsController : Controller
  {
    ...
    public RecommendationsController(SimpleModelsAndRelationsContext context, IHostingEnvironment env, IOptions<MailOptions> mailOptionsAccessor)
    {
      _context = context;
    ...
    public IActionResult View(int id)
    {
      ...
      ViewData["id"] = id;
      ViewData["Page"] = "Recommendations/View";
      return View();
    }
  }
