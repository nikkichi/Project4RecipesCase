...
export function Breakfast_Cuisine_Meal_can_create(self:BreakfastContext) {
...
export function Breakfast_Cuisine_Meal_can_delete(self:BreakfastContext) {
  let state = self.state()
...
export function Breakfast_Cuisine_Meal_page_index(self:BreakfastContext) {
  let state = self.state()
...
export function Breakfast_Cuisine_Meal_page_size(self:BreakfastContext) {
  let state = self.state()
...
export function Breakfast_Cuisine_Meal_search_query(self:BreakfastContext) {
  let state = self.state()
...
export function Breakfast_Cuisine_Meal_num_pages(self:BreakfastContext) {
  let state = self.state()
...
export function load_relation_Breakfast_Cuisine_Meal(self:BreakfastContext, force_first_page:boolean, current_User:Models.User, callback?:()=>void) {
  let state = self.state()
  ...
  Permissions.can_view_Cuisine(current_User) ?
    prelude(() =>
      Api.get_Meal_Cuisine_Meals(self.props.entity, Breakfast_Cuisine_Meal_page_index(self), Breakfast_Cuisine_Meal_page_size(self), Breakfast_Cuisine_Meal_search_query(self)).then(Cuisines =>
...
export function load_relation_Breakfast_Meal_Recipe(self:BreakfastContext, force_first_page:boolean, current_User:Models.User, callback?:()=>void) {
  let state = self.state()
...
export function load_relations_Breakfast(self, current_User:Models.User, callback?:()=>void) {
  load_relation_Breakfast_Meal_Recipe(self, false, self.props.current_User, 
        () => load_relation_Breakfast_Cuisine_Meal(self, false, self.props.current_User, 
        () => callback && callback()))
}
...
export function render_Breakfast_Description_editable_minimised(self:BreakfastContext) : JSX.Element {
  if (!Permissions.can_edit_Breakfast(self.props.current_User)) return render_Breakfast_Description_minimised(self)
  else
    return !Permissions.can_view_Breakfast_Description(self.props.current_User) ? <div /> :
  ...
  <div className="model__attribute-content">
    { Components.String(
        self.props.is_editable && Permissions.can_edit_Breakfast(self.props.current_User) && Permissions.can_edit_Breakfast_Description(self.props.current_User),
        self.props.mode,
...
export function render_Breakfast_Description_editable_maximised(self:BreakfastContext) : JSX.Element {
  if (!Permissions.can_edit_Breakfast(self.props.current_User)) return render_Breakfast_Description_maximised(self)
  else
    return !Permissions.can_view_Breakfast_Description(self.props.current_User) ? <div /> :
          <div className="model__attribute description">
  <label className="attribute-label attribute-label-description">{i18next.t(`Breakfast:Description`, {context: self.props.inline ? "inline" : ""})}</label>
...
export function render_Breakfast_Description_minimised(self:BreakfastContext) : JSX.Element {
      return !Permissions.can_view_Breakfast_Description(self.props.current_User) ? null : <div className="model__attribute description">
  <label className="attribute-label attribute-label-description">{i18next.t(`Breakfast:Description`, {context: self.props.inline ? "inline" : ""})}</label>
  <div className="model__attribute-content">
    { Components.String(
        self.props.is_editable && Permissions.can_edit_Breakfast(self.props.current_User) && Permissions.can_edit_Breakfast_Description(self.props.current_User),
...
export function render_Breakfast_Cuisine_Meal(self:BreakfastContext, context:"presentation_structure"|"default") {
  ...
  return <div>
    ...
    { List.render_relation("breakfast_cuisine_meal",
   "Meal",
   "Cuisine",
   "Cuisines",
  ...
  (
      state.Cuisine != "loading" ?
        ...
        state.Cuisine,
      Breakfast_Cuisine_Meal_page_index(self),
      Breakfast_Cuisine_Meal_num_pages(self),
      new_page_index => {
          let state = self.state()
          state.Cuisine != "loading" &&
...
export function render_add_existing_Breakfast_Cuisine_Meal(self:BreakfastContext) {
...
export function render_new_Breakfast_Cuisine_Meal(self:BreakfastContext) {
    let state = self.state()
    return  self.props.mode == "edit" ?
      <div className="button__actions">
                      ...
                      onClick={() =>
                          Api.create_linked_Meal_Cuisine_Meals_Asian(self.props.entity).then(e => {
                              ...
                              Api.update_Asian(
                                ...
                                load_relation_Breakfast_Cuisine_Meal(self, true, self.props.current_User, () =>
                                    self.setState({...self.state(), add_step_Cuisine:"closed"})
                                  )
                                )
                          })
                      ...
                      onClick={() =>
                          Api.create_linked_Meal_Meal_Recipes_Recipe(self.props.entity).then(e => {
                              ...
                              Api.update_Recipe(
                                ...
                                load_relation_Breakfast_Meal_Recipe(self, true, self.props.current_User, () =>
                                    self.setState({...self.state(), add_step_Recipe:"closed"})
                                  )
                                )
                          })
