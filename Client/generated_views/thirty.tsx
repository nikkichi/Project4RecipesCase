...
export function load_relation_thirty_PreparationTime_Recipe(self:thirtyContext, current_User:Models.User, callback?:()=>void) {
  Permissions.can_view_Recipe(current_User) ?
    Api.get_PreparationTime_PreparationTime_Recipes(self.props.entity, thirty_PreparationTime_Recipe_page_index(self), thirty_PreparationTime_Recipe_page_size(self)).then(Recipes =>
...
export function load_relations_thirty(self, current_User:Models.User, callback?:()=>void) {
  load_relation_thirty_PreparationTime_Recipe(self, self.props.current_User, 
        () => callback && callback())
}
