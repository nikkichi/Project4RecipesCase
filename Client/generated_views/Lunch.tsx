...
export function Lunch_Cuisine_Meal_can_create(self:LunchContext) {
...
export function Lunch_Cuisine_Meal_can_delete(self:LunchContext) {
  let state = self.state()
...
export function Lunch_Cuisine_Meal_page_index(self:LunchContext) {
  let state = self.state()
...
export function Lunch_Cuisine_Meal_page_size(self:LunchContext) {
  let state = self.state()
...
export function Lunch_Cuisine_Meal_search_query(self:LunchContext) {
  let state = self.state()
...
export function Lunch_Cuisine_Meal_num_pages(self:LunchContext) {
  let state = self.state()
...
export function load_relation_Lunch_Cuisine_Meal(self:LunchContext, force_first_page:boolean, current_User:Models.User, callback?:()=>void) {
  let state = self.state()
  ...
  Permissions.can_view_Cuisine(current_User) ?
    prelude(() =>
      Api.get_Meal_Cuisine_Meals(self.props.entity, Lunch_Cuisine_Meal_page_index(self), Lunch_Cuisine_Meal_page_size(self), Lunch_Cuisine_Meal_search_query(self)).then(Cuisines =>
...
export function load_relation_Lunch_Meal_Recipe(self:LunchContext, force_first_page:boolean, current_User:Models.User, callback?:()=>void) {
  let state = self.state()
...
export function load_relations_Lunch(self, current_User:Models.User, callback?:()=>void) {
  load_relation_Lunch_Meal_Recipe(self, false, self.props.current_User, 
        () => load_relation_Lunch_Cuisine_Meal(self, false, self.props.current_User, 
        () => callback && callback()))
}
...
export function render_Lunch_Description_editable_minimised(self:LunchContext) : JSX.Element {
  if (!Permissions.can_edit_Lunch(self.props.current_User)) return render_Lunch_Description_minimised(self)
  else
    return !Permissions.can_view_Lunch_Description(self.props.current_User) ? <div /> :
  ...
  <div className="model__attribute-content">
    { Components.String(
        self.props.is_editable && Permissions.can_edit_Lunch(self.props.current_User) && Permissions.can_edit_Lunch_Description(self.props.current_User),
        self.props.mode,
...
export function render_Lunch_Description_editable_maximised(self:LunchContext) : JSX.Element {
  if (!Permissions.can_edit_Lunch(self.props.current_User)) return render_Lunch_Description_maximised(self)
  else
    return !Permissions.can_view_Lunch_Description(self.props.current_User) ? <div /> :
          <div className="model__attribute description">
  <label className="attribute-label attribute-label-description">{i18next.t(`Lunch:Description`, {context: self.props.inline ? "inline" : ""})}</label>
...
export function render_controls_Lunch(self:LunchContext) {
  return <div className="control">
    ...
    {Permissions.can_delete_Lunch(self.props.current_User) && self.props.size == "fullscreen" ? <a className="button button--delete"
...
export function render_content_Lunch(self:LunchContext) {
  ...
  let content =
    Permissions.can_view_Lunch(self.props.current_User) ?
...
export function render_Lunch_Description_minimised(self:LunchContext) : JSX.Element {
      return !Permissions.can_view_Lunch_Description(self.props.current_User) ? null : <div className="model__attribute description">
  <label className="attribute-label attribute-label-description">{i18next.t(`Lunch:Description`, {context: self.props.inline ? "inline" : ""})}</label>
  <div className="model__attribute-content">
    { Components.String(
        self.props.is_editable && Permissions.can_edit_Lunch(self.props.current_User) && Permissions.can_edit_Lunch_Description(self.props.current_User),
...
export function render_Lunch_Cuisine_Meal(self:LunchContext, context:"presentation_structure"|"default") {
  ...
  return <div>
    ...
    { List.render_relation("lunch_cuisine_meal",
   "Meal",
   "Cuisine",
   "Cuisines",
  ...
  (
      state.Cuisine != "loading" ?
        ...
        state.Cuisine,
      Lunch_Cuisine_Meal_page_index(self),
      Lunch_Cuisine_Meal_num_pages(self),
      new_page_index => {
          let state = self.state()
          state.Cuisine != "loading" &&
...
export function render_add_existing_Lunch_Cuisine_Meal(self:LunchContext) {
...
export function render_new_Lunch_Cuisine_Meal(self:LunchContext) {
    let state = self.state()
    return  self.props.mode == "edit" ?
      <div className="button__actions">
                      ...
                      onClick={() =>
                          Api.create_linked_Meal_Cuisine_Meals_Asian(self.props.entity).then(e => {
                              ...
                              Api.update_Asian(
                                ...
                                load_relation_Lunch_Cuisine_Meal(self, true, self.props.current_User, () =>
                                    self.setState({...self.state(), add_step_Cuisine:"closed"})
                                  )
                                )
                          })
                      ...
                      onClick={() =>
                          Api.create_linked_Meal_Meal_Recipes_Recipe(self.props.entity).then(e => {
                              ...
                              Api.update_Recipe(
                                ...
                                load_relation_Lunch_Meal_Recipe(self, true, self.props.current_User, () =>
                                    self.setState({...self.state(), add_step_Recipe:"closed"})
                                  )
                                )
                          })
...
export let Lunch_to = (id:number, target_element_id:string, current_User:Models.User) => {
