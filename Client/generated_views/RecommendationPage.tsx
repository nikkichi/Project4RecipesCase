...
export function RecommendationPage_User_RecommendationPage_can_create(self:RecommendationPageContext) {
  let state = self.state()
  return state.User == "loading" ? false : state.User.CanCreate
}
export function RecommendationPage_RecommendationPage_Recipe_can_create(self:RecommendationPageContext) {
  let state = self.state()
...
export function RecommendationPage_RecommendationPage_Recipe_page_index(self:RecommendationPageContext) {
  let state = self.state()
...
export function RecommendationPage_RecommendationPage_Recipe_num_pages(self:RecommendationPageContext) {
  let state = self.state()
...
export function set_size_RecommendationPage(self:RecommendationPageContext, new_size:Utils.EntitySize) {
  self.props.set_size(new_size, () => {
    if (new_size == "fullscreen")
      self.props.push(RecommendationPage_to_page(self.props.entity.Id))
  })
}
...
export function render_editable_attributes_minimised_RecommendationPage(self:RecommendationPageContext) {
  let attributes = (<div>
...
export function render_breadcrumb_RecommendationPage(self:RecommendationPageContext) {
  return <div className="breadcrumb-recommendationpage">RecommendationPage</div>
}

export function render_menu_RecommendationPage(self:RecommendationPageContext) {
  let state = self.state()
...
export function render_local_menu_RecommendationPage(self:RecommendationPageContext) {
  let state = self.state()
          ...
          <div className="local_menu_entries">
            <div className={`local_menu_entry${self.props.shown_relation == "none" ? " local_menu_entry--active" : ""}`}>
              <a onClick={() =>
                ...
                {i18next.t('About this RecommendationPage')}
              </a>
            </div>
            ...
            {!Permissions.can_view_Recipe(self.props.current_User) ? null :
                  <div key={"RecommendationPage_Recipe"} className={`local_menu_entry${self.props.shown_relation == "RecommendationPage_Recipe" ? " local_menu_entry--active" : ""}`}>
                    <a onClick={() =>
                      ...
                      {i18next.t('RecommendationPage_Recipes')}
                    </a>
                  </div>
                }  
          </div>
...
export function render_controls_RecommendationPage(self:RecommendationPageContext) {
  return <div className="control">
    {self.props.allow_maximisation && self.props.set_size ? <a className={`"recommendationpage button button--toggle ${self.props.size != 'preview' ? 'button--toggle--open' : ''}`}
          onClick={() => {
            set_size_RecommendationPage(self, self.props.size == "preview" ? "large" : "preview")}
          }>
      </a> : null}
    {self.props.allow_fullscreen && self.props.set_size ? <a className="recommendationpage button button--fullscreen"
        onClick={() => set_size_RecommendationPage(self, self.props.size == "fullscreen" ? "large" : "fullscreen")}>
      </a> : null}
    {Permissions.can_delete_RecommendationPage(self.props.current_User) && self.props.size == "fullscreen" ? <a className="button button--delete"
      onClick={() => confirm(i18next.t('Are you sure?')) &&
        Api.delete_RecommendationPage(self.props.entity).then(() => self.props.force_reload(() => self.props.pop()))
      }>
    </a> : null}
    {self.props.size == "fullscreen" && self.props.pages_count > 0 ? <a className="recommendationpage button button--close"
...
export function render_preview_RecommendationPage(self:RecommendationPageContext) {
...
export function render_RecommendationPage_User_RecommendationPage(self:RecommendationPageContext, context:"presentation_structure"|"default") {
...
export function render_RecommendationPage_RecommendationPage_Recipe(self:RecommendationPageContext, context:"presentation_structure"|"default") {
...
export function render_relations_RecommendationPage(self:RecommendationPageContext) {
  return <div className="relations">
      { render_RecommendationPage_RecommendationPage_Recipe(self, "default") }
      
    </div>
}

export function render_add_existing_RecommendationPage_User_RecommendationPage(self:RecommendationPageContext) {
          ...
          React.createElement(List.AddToRelation,
            {
              ...
              get_items:[
                { name: "User", get: async(i,s) => Api.get_unlinked_RecommendationPage_User_RecommendationPages(self.props.entity, i, s) },
              ]
            })
        }
      </div>
...
export function render_add_existing_RecommendationPage_RecommendationPage_Recipe(self:RecommendationPageContext) {
          ...
          React.createElement(List.AddToRelation,
            {
              ...
              get_items:[
                { name: "Recipe", get: async(i,s) => Api.get_unlinked_RecommendationPage_RecommendationPage_Recipes(self.props.entity, i, s) },
              ]
            })
        }
      </div>
...
export function render_new_RecommendationPage_User_RecommendationPage(self:RecommendationPageContext) {
    let state = self.state()
...
export function render_new_RecommendationPage_RecommendationPage_Recipe(self:RecommendationPageContext) {
    let state = self.state()
    return  self.props.mode == "edit" ?
      <div className="button__actions">
...
export function render_saving_animations_RecommendationPage(self:RecommendationPageContext) {
...
export type RecommendationPageContext = {state:()=>RecommendationPageState, props:Utils.EntityComponentProps<Models.RecommendationPage>, setState:(new_state:RecommendationPageState, callback?:()=>void) => void}
...
export class RecommendationPageComponent extends React.Component<Utils.EntityComponentProps<Models.RecommendationPage>, RecommendationPageState> {
  ...
  componentWillReceiveProps(new_props:Utils.EntityComponentProps<Models.RecommendationPage>) {
  ...
  render() {
    ...
    return <div id={`RecommendationPage_${this.props.entity.Id.toString()}_${this.state.update_count}`} className={`model recommendationpage`}>
...
export let RecommendationPage = (props:Utils.EntityComponentProps<Models.RecommendationPage>) : JSX.Element =>
...
export let RecommendationPage_to = (id:number, target_element_id:string, current_User:Models.User) => {
  Utils.render_page_manager(target_element_id,
    RecommendationPage_to_page(id),
    current_User
  )
}
