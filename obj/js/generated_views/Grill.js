...
function load_relation_Grill_Cuisine_Meal(self, force_first_page, current_User, callback) {
    ...
    Permissions.can_view_Meal(current_User) ?
        prelude(() => Api.get_Cuisine_Cuisine_Meals(self.props.entity, Grill_Cuisine_Meal_page_index(self), Grill_Cuisine_Meal_page_size(self), Grill_Cuisine_Meal_search_query(self)).then(Meals => self.setState(Object.assign({}, self.state(), { update_count: self.state().update_count + 1, Meal: Utils.raw_page_to_paginated_items((i, i_just_created) => {
                let state = self.state();
                return {
                    element: i,
...
function set_size_Grill(self, new_size) {
    self.props.set_size(new_size, () => {
        if (new_size == "fullscreen")
            self.props.push(exports.Grill_to_page(self.props.entity.Id));
    });
}
exports.set_size_Grill = set_size_Grill;
function render_Grill_Description_editable_minimised(self) {
    if (!Permissions.can_edit_Grill(self.props.current_User))
        return render_Grill_Description_minimised(self);
    else
        return !Permissions.can_view_Grill_Description(self.props.current_User) ? React.createElement("div", null) :
            React.createElement("div", { className: "model__attribute description" },
                React.createElement("label", { className: "attribute-label attribute-label-description" }, i18next.t(`Grill:Description`, { context: self.props.inline ? "inline" : "" })),
                React.createElement("div", { className: "model__attribute-content" }, Components.String(self.props.is_editable && Permissions.can_edit_Grill(self.props.current_User) && Permissions.can_edit_Grill_Description(self.props.current_User), self.props.mode, () => self.props.entity.Description, v => self.props.set_entity(Object.assign({}, self.props.entity, { Description: v })))));
}
exports.render_Grill_Description_editable_minimised = render_Grill_Description_editable_minimised;
function render_Grill_Description_editable_maximised(self) {
    if (!Permissions.can_edit_Grill(self.props.current_User))
        return render_Grill_Description_maximised(self);
    else
        return !Permissions.can_view_Grill_Description(self.props.current_User) ? React.createElement("div", null) :
            React.createElement("div", { className: "model__attribute description" },
                React.createElement("label", { className: "attribute-label attribute-label-description" }, i18next.t(`Grill:Description`, { context: self.props.inline ? "inline" : "" })),
...
exports.render_Grill_Description_editable_maximised = render_Grill_Description_editable_maximised;
function render_editable_attributes_minimised_Grill(self) {
    let attributes = (React.createElement("div", null, render_Grill_Description_editable_minimised(self)));
    return attributes;
}
exports.render_editable_attributes_minimised_Grill = render_editable_attributes_minimised_Grill;
function render_editable_attributes_maximised_Grill(self) {
    let state = self.state();
    let attributes = (React.createElement("div", null, render_Grill_Description_editable_maximised(self)));
    return attributes;
}
exports.render_editable_attributes_maximised_Grill = render_editable_attributes_maximised_Grill;
function render_breadcrumb_Grill(self) {
    return React.createElement("div", { className: "breadcrumb-grill" }, "Grill");
}
exports.render_breadcrumb_Grill = render_breadcrumb_Grill;
function render_menu_Grill(self) {
    let state = self.state();
...
exports.render_menu_Grill = render_menu_Grill;
function render_local_menu_Grill(self) {
    let state = self.state();
...
function render_controls_Grill(self) {
    return React.createElement("div", { className: "control" },
        self.props.allow_maximisation && self.props.set_size ? React.createElement("a", { className: `"grill button button--toggle ${self.props.size != 'preview' ? 'button--toggle--open' : ''}`, onClick: () => {
                set_size_Grill(self, self.props.size == "preview" ? "large" : "preview");
            } }) : null,
        self.props.allow_fullscreen && self.props.set_size ? React.createElement("a", { className: "grill button button--fullscreen", onClick: () => set_size_Grill(self, self.props.size == "fullscreen" ? "large" : "fullscreen") }) : null,
        Permissions.can_delete_Grill(self.props.current_User) && self.props.size == "fullscreen" ? React.createElement("a", { className: "button button--delete", onClick: () => confirm(i18next.t('Are you sure?')) &&
                Api.delete_Grill(self.props.entity).then(() => self.props.force_reload(() => self.props.pop())) }) : null,
        self.props.size == "fullscreen" && self.props.pages_count > 0 ? React.createElement("a", { className: "grill button button--close", onClick: () => self.props.pop() }) : null,
...
exports.render_controls_Grill = render_controls_Grill;
function render_content_Grill(self) {
    let actions = [
        self.props.allow_maximisation && self.props.set_size && self.props.size == "preview" ?
            ...
            () => set_size_Grill(self, self.props.size == "fullscreen" ? "large" : "fullscreen")
            :
                null,
    ].filter(a => a != null);
    let content = Permissions.can_view_Grill(self.props.current_User) ?
...
exports.render_content_Grill = render_content_Grill;
function render_Grill_Description_minimised(self) {
    return !Permissions.can_view_Grill_Description(self.props.current_User) ? null : React.createElement("div", { className: "model__attribute description" },
        React.createElement("label", { className: "attribute-label attribute-label-description" }, i18next.t(`Grill:Description`, { context: self.props.inline ? "inline" : "" })),
        React.createElement("div", { className: "model__attribute-content" }, Components.String(self.props.is_editable && Permissions.can_edit_Grill(self.props.current_User) && Permissions.can_edit_Grill_Description(self.props.current_User), self.props.mode, () => self.props.entity.Description, v => self.props.set_entity(Object.assign({}, self.props.entity, { Description: v })))));
}
exports.render_Grill_Description_minimised = render_Grill_Description_minimised;
function render_Grill_Description_maximised(self) {
    return !Permissions.can_view_Grill_Description(self.props.current_User) ? null : React.createElement("div", { className: "model__attribute description" },
        React.createElement("label", { className: "attribute-label attribute-label-description" }, i18next.t(`Grill:Description`, { context: self.props.inline ? "inline" : "" })),
        React.createElement("div", { className: "model__attribute-content" }, Components.String(self.props.is_editable && Permissions.can_edit_Grill(self.props.current_User) && Permissions.can_edit_Grill_Description(self.props.current_User), self.props.mode, () => self.props.entity.Description, v => self.props.set_entity(Object.assign({}, self.props.entity, { Description: v })))));
}
exports.render_Grill_Description_maximised = render_Grill_Description_maximised;
function render_preview_Grill(self) {
    let attributes = null;
    if (self.props.mode == "view" || !Permissions.can_edit_Grill(self.props.current_User))
        attributes = (React.createElement("div", { className: "model__attributes" }, render_Grill_Description_minimised(self)));
    else
        attributes = render_editable_attributes_minimised_Grill(self);
    return (React.createElement("div", { className: "block" }, attributes));
}
exports.render_preview_Grill = render_preview_Grill;
function render_large_Grill(self) {
    let state = self.state();
    let attributes = null;
    if (self.props.mode == "view" || !Permissions.can_edit_Grill(self.props.current_User))
        attributes = (React.createElement("div", { className: "model__attributes" }, render_Grill_Description_maximised(self)));
    else
...
exports.render_large_Grill = render_large_Grill;
function render_Grill_Cuisine_Meal(self, context) {
    if ((context == "default" && self.props.shown_relation != "all" && self.props.shown_relation != "Cuisine_Meal") || !Permissions.can_view_Meal(self.props.current_User))
        return null;
    let state = self.state();
    return React.createElement("div", null, List.render_relation("grill_cuisine_meal", "Cuisine", "Meal", "Meals", self.props.nesting_depth > 0, false, false, false)(state.Meal != "loading" ?
        state.Meal.IdsInServerOrder.map(id => state.Meal != "loading" && state.Meal.Items.get(id)) :
        state.Meal, Grill_Cuisine_Meal_page_index(self), Grill_Cuisine_Meal_num_pages(self), new_page_index => {
        let state = self.state();
        state.Meal != "loading" &&
            self.setState(Object.assign({}, self.state(), { update_count: self.state().update_count + 1, Meal: Object.assign({}, state.Meal, { PageIndex: new_page_index }) }), () => load_relation_Grill_Cuisine_Meal(self, false, self.props.current_User));
    }, (i, _) => {
        ...
        return React.createElement("div", { key: i_id, className: `model-nested__item ${i.size != "preview" ? "model-nested__item--open" : ""}
            ...
            React.createElement("div", { key: i_id }, MealViews.Meal(Object.assign({}, self.props, { entity: i.element, inline: false, nesting_depth: self.props.nesting_depth + 1, size: i.size, allow_maximisation: true, allow_fullscreen: true, mode: self.props.mode == "edit" && (Permissions.can_edit_Cuisine_Meal(self.props.current_User)
                    ...
                    null
                    :
                        () => confirm(i18next.t('Are you sure?')) && Api.unlink_Cuisine_Cuisine_Meals(self.props.entity, i.element).then(() => load_relation_Grill_Cuisine_Meal(self, false, self.props.current_User)) }))));
    }, () => React.createElement("div", null,
        Permissions.can_create_Meal(self.props.current_User) && Permissions.can_create_Cuisine_Meal(self.props.current_User) && Grill_Cuisine_Meal_can_create(self) ? render_new_Grill_Cuisine_Meal(self) : null,
                    ...
                    React.createElement("div", { className: "overlay__item overlay__item--new" },
                        React.createElement("div", { className: "new-lunch" },
                            React.createElement("button", { className: "new-lunch button button--new", onClick: () => Api.create_linked_Cuisine_Cuisine_Meals_Lunch(self.props.entity).then(e => {
                                    e.length > 0 &&
                                        Api.update_Lunch(Object.assign({}, e[0], { Kind: "Lunch", Description: "" })).then(() => load_relation_Grill_Cuisine_Meal(self, true, self.props.current_User, () => self.setState(Object.assign({}, self.state(), { add_step_Meal: "closed" }))));
                        ...
                        React.createElement("div", { className: "new-brunch" },
                            React.createElement("button", { className: "new-brunch button button--new", onClick: () => Api.create_linked_Cuisine_Cuisine_Meals_Brunch(self.props.entity).then(e => {
                                    e.length > 0 &&
                                        Api.update_Brunch(Object.assign({}, e[0], { Kind: "Brunch", Description: "" })).then(() => load_relation_Grill_Cuisine_Meal(self, true, self.props.current_User, () => self.setState(Object.assign({}, self.state(), { add_step_Meal: "closed" }))));
                        ...
                        React.createElement("div", { className: "new-dinner" },
                            React.createElement("button", { className: "new-dinner button button--new", onClick: () => Api.create_linked_Cuisine_Cuisine_Meals_Dinner(self.props.entity).then(e => {
                                    e.length > 0 &&
                                        Api.update_Dinner(Object.assign({}, e[0], { Kind: "Dinner", Description: "" })).then(() => load_relation_Grill_Cuisine_Meal(self, true, self.props.current_User, () => self.setState(Object.assign({}, self.state(), { add_step_Meal: "closed" }))));
                        ...
                        React.createElement("div", { className: "new-breakfast" },
                            React.createElement("button", { className: "new-breakfast button button--new", onClick: () => Api.create_linked_Cuisine_Cuisine_Meals_Breakfast(self.props.entity).then(e => {
                                    e.length > 0 &&
                                        Api.update_Breakfast(Object.assign({}, e[0], { Kind: "Breakfast", Description: "" })).then(() => load_relation_Grill_Cuisine_Meal(self, true, self.props.current_User, () => self.setState(Object.assign({}, self.state(), { add_step_Meal: "closed" }))));
...
class GrillComponent extends React.Component {
    ...
    componentWillReceiveProps(new_props) {
        ...
        if (new_props.mode != this.props.mode || (new_props.size != this.props.size && (new_props.size == "large" || new_props.size == "fullscreen")) ||
            ...
            load_relations_Grill(this.get_self(), new_props.current_User);
        }
    }
    componentWillMount() {
        ...
        if (this.props.size != "preview") {
            load_relations_Grill(this.get_self(), this.props.current_User);
        }
    ...
    render() {
        if (this.props.size == "breadcrumb") {
            return Permissions.can_view_Grill(this.props.current_User) ?
                render_breadcrumb_Grill(this.get_self())
                : null;
        }
        return React.createElement("div", { id: `Grill_${this.props.entity.Id.toString()}_${this.state.update_count}`, className: `model grill` },
...
exports.Grill_to = (id, target_element_id, current_User) => {
    Utils.render_page_manager(target_element_id, exports.Grill_to_page(id), current_User);
};
