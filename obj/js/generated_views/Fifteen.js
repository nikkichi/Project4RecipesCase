...
exports.Fifteen_PreparationTime_Recipe_can_create = Fifteen_PreparationTime_Recipe_can_create;
function Fifteen_PreparationTime_Recipe_can_delete(self) {
    let state = self.state();
    return state.Recipe == "loading" ? false : state.Recipe.CanDelete;
}
exports.Fifteen_PreparationTime_Recipe_can_delete = Fifteen_PreparationTime_Recipe_can_delete;
function Fifteen_PreparationTime_Recipe_page_index(self) {
    let state = self.state();
    return state.Recipe == "loading" ? 0 : state.Recipe.PageIndex;
}
exports.Fifteen_PreparationTime_Recipe_page_index = Fifteen_PreparationTime_Recipe_page_index;
function Fifteen_PreparationTime_Recipe_page_size(self) {
    let state = self.state();
    return state.Recipe == "loading" ? 25 : state.Recipe.PageSize;
}
exports.Fifteen_PreparationTime_Recipe_page_size = Fifteen_PreparationTime_Recipe_page_size;
function Fifteen_PreparationTime_Recipe_search_query(self) {
    let state = self.state();
    return state.Recipe == "loading" ? null : state.Recipe.SearchQuery;
}
exports.Fifteen_PreparationTime_Recipe_search_query = Fifteen_PreparationTime_Recipe_search_query;
function Fifteen_PreparationTime_Recipe_num_pages(self) {
    let state = self.state();
    return state.Recipe == "loading" ? 1 : state.Recipe.NumPages;
}
exports.Fifteen_PreparationTime_Recipe_num_pages = Fifteen_PreparationTime_Recipe_num_pages;
function load_relation_Fifteen_PreparationTime_Recipe(self, force_first_page, current_User, callback) {
    let state = self.state();
    ...
    Permissions.can_view_Recipe(current_User) ?
        prelude(() => Api.get_PreparationTime_PreparationTime_Recipes(self.props.entity, Fifteen_PreparationTime_Recipe_page_index(self), Fifteen_PreparationTime_Recipe_page_size(self), Fifteen_PreparationTime_Recipe_search_query(self)).then(Recipes => self.setState(Object.assign({}, self.state(), { update_count: self.state().update_count + 1, Recipe: Utils.raw_page_to_paginated_items((i, i_just_created) => {
                let state = self.state();
                return {
                    element: i,
...
exports.load_relation_Fifteen_PreparationTime_Recipe = load_relation_Fifteen_PreparationTime_Recipe;
function load_relations_Fifteen(self, current_User, callback) {
    load_relation_Fifteen_PreparationTime_Recipe(self, false, self.props.current_User, () => callback && callback());
}
exports.load_relations_Fifteen = load_relations_Fifteen;
function set_size_Fifteen(self, new_size) {
    self.props.set_size(new_size, () => {
        if (new_size == "fullscreen")
            self.props.push(exports.Fifteen_to_page(self.props.entity.Id));
    });
}
exports.set_size_Fifteen = set_size_Fifteen;
function render_Fifteen_Description_editable_minimised(self) {
    if (!Permissions.can_edit_Fifteen(self.props.current_User))
        return render_Fifteen_Description_minimised(self);
    else
        return !Permissions.can_view_Fifteen_Description(self.props.current_User) ? React.createElement("div", null) :
            React.createElement("div", { className: "model__attribute description" },
                React.createElement("label", { className: "attribute-label attribute-label-description" }, i18next.t(`Fifteen:Description`, { context: self.props.inline ? "inline" : "" })),
                React.createElement("div", { className: "model__attribute-content" }, Components.String(self.props.is_editable && Permissions.can_edit_Fifteen(self.props.current_User) && Permissions.can_edit_Fifteen_Description(self.props.current_User), self.props.mode, () => self.props.entity.Description, v => self.props.set_entity(Object.assign({}, self.props.entity, { Description: v })))));
}
exports.render_Fifteen_Description_editable_minimised = render_Fifteen_Description_editable_minimised;
function render_Fifteen_Description_editable_maximised(self) {
    if (!Permissions.can_edit_Fifteen(self.props.current_User))
        return render_Fifteen_Description_maximised(self);
    else
        return !Permissions.can_view_Fifteen_Description(self.props.current_User) ? React.createElement("div", null) :
            React.createElement("div", { className: "model__attribute description" },
                React.createElement("label", { className: "attribute-label attribute-label-description" }, i18next.t(`Fifteen:Description`, { context: self.props.inline ? "inline" : "" })),
...
exports.render_Fifteen_Description_editable_maximised = render_Fifteen_Description_editable_maximised;
function render_editable_attributes_minimised_Fifteen(self) {
    let attributes = (React.createElement("div", null, render_Fifteen_Description_editable_minimised(self)));
    return attributes;
}
exports.render_editable_attributes_minimised_Fifteen = render_editable_attributes_minimised_Fifteen;
function render_editable_attributes_maximised_Fifteen(self) {
    let state = self.state();
    let attributes = (React.createElement("div", null, render_Fifteen_Description_editable_maximised(self)));
    return attributes;
}
exports.render_editable_attributes_maximised_Fifteen = render_editable_attributes_maximised_Fifteen;
function render_breadcrumb_Fifteen(self) {
    return React.createElement("div", { className: "breadcrumb-fifteen" }, "Fifteen");
}
exports.render_breadcrumb_Fifteen = render_breadcrumb_Fifteen;
function render_menu_Fifteen(self) {
    let state = self.state();
...
exports.render_menu_Fifteen = render_menu_Fifteen;
function render_local_menu_Fifteen(self) {
    let state = self.state();
    return React.createElement("div", { className: "local-menu" },
        React.createElement("div", { className: "local_menu_entries" },
            React.createElement("div", { className: `local_menu_entry${self.props.shown_relation == "none" ? " local_menu_entry--active" : ""}` },
                React.createElement("a", { onClick: () => self.props.set_shown_relation("none") }, i18next.t('About this Fifteen'))),
            !Permissions.can_view_Recipe(self.props.current_User) ? null :
                React.createElement("div", { key: "PreparationTime_Recipe", className: `local_menu_entry${self.props.shown_relation == "PreparationTime_Recipe" ? " local_menu_entry--active" : ""}` },
                    React.createElement("a", { onClick: () => load_relation_Fifteen_PreparationTime_Recipe(self, false, self.props.current_User, () => self.props.set_shown_relation("PreparationTime_Recipe")) }, i18next.t('PreparationTime_Recipes')))));
}
exports.render_local_menu_Fifteen = render_local_menu_Fifteen;
function render_controls_Fifteen(self) {
    return React.createElement("div", { className: "control" },
        self.props.allow_maximisation && self.props.set_size ? React.createElement("a", { className: `"fifteen button button--toggle ${self.props.size != 'preview' ? 'button--toggle--open' : ''}`, onClick: () => {
                set_size_Fifteen(self, self.props.size == "preview" ? "large" : "preview");
            } }) : null,
        self.props.allow_fullscreen && self.props.set_size ? React.createElement("a", { className: "fifteen button button--fullscreen", onClick: () => set_size_Fifteen(self, self.props.size == "fullscreen" ? "large" : "fullscreen") }) : null,
        Permissions.can_delete_Fifteen(self.props.current_User) && self.props.size == "fullscreen" ? React.createElement("a", { className: "button button--delete", onClick: () => confirm(i18next.t('Are you sure?')) &&
                Api.delete_Fifteen(self.props.entity).then(() => self.props.force_reload(() => self.props.pop())) }) : null,
        self.props.size == "fullscreen" && self.props.pages_count > 0 ? React.createElement("a", { className: "fifteen button button--close", onClick: () => self.props.pop() }) : null,
...
exports.render_controls_Fifteen = render_controls_Fifteen;
function render_content_Fifteen(self) {
    let actions = [
    ...
    let content = Permissions.can_view_Fifteen(self.props.current_User) ?
...
exports.render_content_Fifteen = render_content_Fifteen;
function render_Fifteen_Description_minimised(self) {
    return !Permissions.can_view_Fifteen_Description(self.props.current_User) ? null : React.createElement("div", { className: "model__attribute description" },
        React.createElement("label", { className: "attribute-label attribute-label-description" }, i18next.t(`Fifteen:Description`, { context: self.props.inline ? "inline" : "" })),
        React.createElement("div", { className: "model__attribute-content" }, Components.String(self.props.is_editable && Permissions.can_edit_Fifteen(self.props.current_User) && Permissions.can_edit_Fifteen_Description(self.props.current_User), self.props.mode, () => self.props.entity.Description, v => self.props.set_entity(Object.assign({}, self.props.entity, { Description: v })))));
}
exports.render_Fifteen_Description_minimised = render_Fifteen_Description_minimised;
function render_Fifteen_Description_maximised(self) {
    return !Permissions.can_view_Fifteen_Description(self.props.current_User) ? null : React.createElement("div", { className: "model__attribute description" },
        React.createElement("label", { className: "attribute-label attribute-label-description" }, i18next.t(`Fifteen:Description`, { context: self.props.inline ? "inline" : "" })),
        React.createElement("div", { className: "model__attribute-content" }, Components.String(self.props.is_editable && Permissions.can_edit_Fifteen(self.props.current_User) && Permissions.can_edit_Fifteen_Description(self.props.current_User), self.props.mode, () => self.props.entity.Description, v => self.props.set_entity(Object.assign({}, self.props.entity, { Description: v })))));
}
exports.render_Fifteen_Description_maximised = render_Fifteen_Description_maximised;
function render_preview_Fifteen(self) {
    let attributes = null;
    if (self.props.mode == "view" || !Permissions.can_edit_Fifteen(self.props.current_User))
        attributes = (React.createElement("div", { className: "model__attributes" }, render_Fifteen_Description_minimised(self)));
    else
        attributes = render_editable_attributes_minimised_Fifteen(self);
    return (React.createElement("div", { className: "block" }, attributes));
}
exports.render_preview_Fifteen = render_preview_Fifteen;
function render_large_Fifteen(self) {
    let state = self.state();
    let attributes = null;
    if (self.props.mode == "view" || !Permissions.can_edit_Fifteen(self.props.current_User))
        attributes = (React.createElement("div", { className: "model__attributes" }, render_Fifteen_Description_maximised(self)));
    else
...
exports.render_large_Fifteen = render_large_Fifteen;
function render_Fifteen_PreparationTime_Recipe(self, context) {
    if ((context == "default" && self.props.shown_relation != "all" && self.props.shown_relation != "PreparationTime_Recipe") || !Permissions.can_view_Recipe(self.props.current_User))
        return null;
    let state = self.state();
    return React.createElement("div", null, List.render_relation("fifteen_preparationtime_recipe", "PreparationTime", "Recipe", "Recipes", self.props.nesting_depth > 0, false, false, false)(state.Recipe != "loading" ?
        state.Recipe.IdsInServerOrder.map(id => state.Recipe != "loading" && state.Recipe.Items.get(id)) :
        state.Recipe, Fifteen_PreparationTime_Recipe_page_index(self), Fifteen_PreparationTime_Recipe_num_pages(self), new_page_index => {
        let state = self.state();
        state.Recipe != "loading" &&
            self.setState(Object.assign({}, self.state(), { update_count: self.state().update_count + 1, Recipe: Object.assign({}, state.Recipe, { PageIndex: new_page_index }) }), () => load_relation_Fifteen_PreparationTime_Recipe(self, false, self.props.current_User));
    }, (i, _) => {
        ...
        return React.createElement("div", { key: i_id, className: `model-nested__item ${i.size != "preview" ? "model-nested__item--open" : ""}
            ...
            React.createElement("div", { key: i_id }, RecipeViews.Recipe(Object.assign({}, self.props, { entity: i.element, inline: false, nesting_depth: self.props.nesting_depth + 1, size: i.size, allow_maximisation: true, allow_fullscreen: true, mode: self.props.mode == "edit" && (Permissions.can_edit_PreparationTime_Recipe(self.props.current_User)
                    ...
                    null
                    :
                        () => confirm(i18next.t('Are you sure?')) && Api.unlink_PreparationTime_PreparationTime_Recipes(self.props.entity, i.element).then(() => load_relation_Fifteen_PreparationTime_Recipe(self, false, self.props.current_User)) }))));
...
exports.render_Fifteen_PreparationTime_Recipe = render_Fifteen_PreparationTime_Recipe;
function render_relations_Fifteen(self) {
    return React.createElement("div", { className: "relations" }, render_Fifteen_PreparationTime_Recipe(self, "default"));
}
exports.render_relations_Fifteen = render_relations_Fifteen;
function render_add_existing_Fifteen_PreparationTime_Recipe(self) {
    let state = self.state();
...
exports.render_add_existing_Fifteen_PreparationTime_Recipe = render_add_existing_Fifteen_PreparationTime_Recipe;
function render_new_Fifteen_PreparationTime_Recipe(self) {
    let state = self.state();
    return self.props.mode == "edit" ?
        React.createElement("div", { className: "button__actions" },
            React.createElement("div", { className: "new-recipe" },
                React.createElement("button", { className: "new-recipe button button--new", onClick: () => Api.create_linked_PreparationTime_PreparationTime_Recipes_Recipe(self.props.entity).then(e => {
                        e.length > 0 &&
                            Api.update_Recipe(Object.assign({}, e[0], { Name: "", Ingredients: "", Description: "", Picture: "" })).then(() => load_relation_Fifteen_PreparationTime_Recipe(self, true, self.props.current_User, () => self.setState(Object.assign({}, self.state(), { add_step_Recipe: "closed" }))));
                    }) }, i18next.t('Create new Recipe'))))
        :
            null;
}
exports.render_new_Fifteen_PreparationTime_Recipe = render_new_Fifteen_PreparationTime_Recipe;
function render_saving_animations_Fifteen(self) {
...
exports.render_saving_animations_Fifteen = render_saving_animations_Fifteen;
class FifteenComponent extends React.Component {
    ...
    render() {
        ...
        return React.createElement("div", { id: `Fifteen_${this.props.entity.Id.toString()}_${this.state.update_count}`, className: `model fifteen` },
...
exports.FifteenComponent = FifteenComponent;
exports.Fifteen = (props) => React.createElement(FifteenComponent, Object.assign({}, props));
exports.Fifteen_to_page = (id) => {
    ...
    return Utils.scene_to_page(can_edit, exports.Fifteen, Api.get_Fifteen(id), Api.update_Fifteen, "Fifteen", "Fifteen", `/Fifteens/${id}`);
};
exports.Fifteen_to = (id, target_element_id, current_User) => {
    Utils.render_page_manager(target_element_id, exports.Fifteen_to_page(id), current_User);
};
