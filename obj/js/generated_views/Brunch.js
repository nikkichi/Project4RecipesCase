...
exports.Brunch_Cuisine_Meal_can_create = Brunch_Cuisine_Meal_can_create;
function Brunch_Meal_Recipe_can_create(self) {
    let state = self.state();
    return state.Recipe == "loading" ? false : state.Recipe.CanCreate;
}
exports.Brunch_Meal_Recipe_can_create = Brunch_Meal_Recipe_can_create;
function Brunch_Cuisine_Meal_can_delete(self) {
    let state = self.state();
    return state.Cuisine == "loading" ? false : state.Cuisine.CanDelete;
}
exports.Brunch_Cuisine_Meal_can_delete = Brunch_Cuisine_Meal_can_delete;
function Brunch_Meal_Recipe_can_delete(self) {
    let state = self.state();
    return state.Recipe == "loading" ? false : state.Recipe.CanDelete;
}
exports.Brunch_Meal_Recipe_can_delete = Brunch_Meal_Recipe_can_delete;
function Brunch_Cuisine_Meal_page_index(self) {
    let state = self.state();
    return state.Cuisine == "loading" ? 0 : state.Cuisine.PageIndex;
}
exports.Brunch_Cuisine_Meal_page_index = Brunch_Cuisine_Meal_page_index;
function Brunch_Meal_Recipe_page_index(self) {
    let state = self.state();
    return state.Recipe == "loading" ? 0 : state.Recipe.PageIndex;
}
exports.Brunch_Meal_Recipe_page_index = Brunch_Meal_Recipe_page_index;
function Brunch_Cuisine_Meal_page_size(self) {
    let state = self.state();
    return state.Cuisine == "loading" ? 25 : state.Cuisine.PageSize;
}
exports.Brunch_Cuisine_Meal_page_size = Brunch_Cuisine_Meal_page_size;
function Brunch_Meal_Recipe_page_size(self) {
    let state = self.state();
    return state.Recipe == "loading" ? 25 : state.Recipe.PageSize;
}
exports.Brunch_Meal_Recipe_page_size = Brunch_Meal_Recipe_page_size;
function Brunch_Cuisine_Meal_search_query(self) {
    let state = self.state();
    return state.Cuisine == "loading" ? null : state.Cuisine.SearchQuery;
}
exports.Brunch_Cuisine_Meal_search_query = Brunch_Cuisine_Meal_search_query;
function Brunch_Meal_Recipe_search_query(self) {
    let state = self.state();
    return state.Recipe == "loading" ? null : state.Recipe.SearchQuery;
}
exports.Brunch_Meal_Recipe_search_query = Brunch_Meal_Recipe_search_query;
function Brunch_Cuisine_Meal_num_pages(self) {
    let state = self.state();
    return state.Cuisine == "loading" ? 1 : state.Cuisine.NumPages;
}
exports.Brunch_Cuisine_Meal_num_pages = Brunch_Cuisine_Meal_num_pages;
function Brunch_Meal_Recipe_num_pages(self) {
    let state = self.state();
    return state.Recipe == "loading" ? 1 : state.Recipe.NumPages;
}
exports.Brunch_Meal_Recipe_num_pages = Brunch_Meal_Recipe_num_pages;
function load_relation_Brunch_Cuisine_Meal(self, force_first_page, current_User, callback) {
    let state = self.state();
    ...
    Permissions.can_view_Cuisine(current_User) ?
        prelude(() => Api.get_Meal_Cuisine_Meals(self.props.entity, Brunch_Cuisine_Meal_page_index(self), Brunch_Cuisine_Meal_page_size(self), Brunch_Cuisine_Meal_search_query(self)).then(Cuisines => self.setState(Object.assign({}, self.state(), { update_count: self.state().update_count + 1, Cuisine: Utils.raw_page_to_paginated_items((i, i_just_created) => {
                let state = self.state();
                return {
                    element: i,
...
exports.load_relation_Brunch_Cuisine_Meal = load_relation_Brunch_Cuisine_Meal;
function load_relation_Brunch_Meal_Recipe(self, force_first_page, current_User, callback) {
    let state = self.state();
    ...
    Permissions.can_view_Recipe(current_User) ?
        prelude(() => Api.get_Meal_Meal_Recipes(self.props.entity, Brunch_Meal_Recipe_page_index(self), Brunch_Meal_Recipe_page_size(self), Brunch_Meal_Recipe_search_query(self)).then(Recipes => self.setState(Object.assign({}, self.state(), { update_count: self.state().update_count + 1, Recipe: Utils.raw_page_to_paginated_items((i, i_just_created) => {
                let state = self.state();
                return {
                    element: i,
...
exports.load_relation_Brunch_Meal_Recipe = load_relation_Brunch_Meal_Recipe;
function load_relations_Brunch(self, current_User, callback) {
    load_relation_Brunch_Meal_Recipe(self, false, self.props.current_User, () => load_relation_Brunch_Cuisine_Meal(self, false, self.props.current_User, () => callback && callback()));
}
exports.load_relations_Brunch = load_relations_Brunch;
function set_size_Brunch(self, new_size) {
    self.props.set_size(new_size, () => {
        if (new_size == "fullscreen")
            self.props.push(exports.Brunch_to_page(self.props.entity.Id));
    });
}
exports.set_size_Brunch = set_size_Brunch;
function render_Brunch_Description_editable_minimised(self) {
    if (!Permissions.can_edit_Brunch(self.props.current_User))
        return render_Brunch_Description_minimised(self);
    else
        return !Permissions.can_view_Brunch_Description(self.props.current_User) ? React.createElement("div", null) :
            React.createElement("div", { className: "model__attribute description" },
                React.createElement("label", { className: "attribute-label attribute-label-description" }, i18next.t(`Brunch:Description`, { context: self.props.inline ? "inline" : "" })),
                React.createElement("div", { className: "model__attribute-content" }, Components.String(self.props.is_editable && Permissions.can_edit_Brunch(self.props.current_User) && Permissions.can_edit_Brunch_Description(self.props.current_User), self.props.mode, () => self.props.entity.Description, v => self.props.set_entity(Object.assign({}, self.props.entity, { Description: v })))));
}
exports.render_Brunch_Description_editable_minimised = render_Brunch_Description_editable_minimised;
function render_Brunch_Description_editable_maximised(self) {
    if (!Permissions.can_edit_Brunch(self.props.current_User))
        return render_Brunch_Description_maximised(self);
    else
        return !Permissions.can_view_Brunch_Description(self.props.current_User) ? React.createElement("div", null) :
            React.createElement("div", { className: "model__attribute description" },
                React.createElement("label", { className: "attribute-label attribute-label-description" }, i18next.t(`Brunch:Description`, { context: self.props.inline ? "inline" : "" })),
...
exports.render_Brunch_Description_editable_maximised = render_Brunch_Description_editable_maximised;
function render_editable_attributes_minimised_Brunch(self) {
    let attributes = (React.createElement("div", null, render_Brunch_Description_editable_minimised(self)));
    return attributes;
}
exports.render_editable_attributes_minimised_Brunch = render_editable_attributes_minimised_Brunch;
function render_editable_attributes_maximised_Brunch(self) {
    let state = self.state();
    let attributes = (React.createElement("div", null, render_Brunch_Description_editable_maximised(self)));
    return attributes;
}
exports.render_editable_attributes_maximised_Brunch = render_editable_attributes_maximised_Brunch;
function render_breadcrumb_Brunch(self) {
    return React.createElement("div", { className: "breadcrumb-brunch" }, "Brunch");
}
exports.render_breadcrumb_Brunch = render_breadcrumb_Brunch;
function render_menu_Brunch(self) {
    let state = self.state();
...
exports.render_menu_Brunch = render_menu_Brunch;
function render_local_menu_Brunch(self) {
    let state = self.state();
    return React.createElement("div", { className: "local-menu" },
        React.createElement("div", { className: "local_menu_entries" },
            React.createElement("div", { className: `local_menu_entry${self.props.shown_relation == "none" ? " local_menu_entry--active" : ""}` },
                React.createElement("a", { onClick: () => self.props.set_shown_relation("none") }, i18next.t('About this Brunch'))),
            !Permissions.can_view_Recipe(self.props.current_User) ? null :
                React.createElement("div", { key: "Meal_Recipe", className: `local_menu_entry${self.props.shown_relation == "Meal_Recipe" ? " local_menu_entry--active" : ""}` },
                    React.createElement("a", { onClick: () => load_relation_Brunch_Meal_Recipe(self, false, self.props.current_User, () => self.props.set_shown_relation("Meal_Recipe")) }, i18next.t('Meal_Recipes')))));
}
exports.render_local_menu_Brunch = render_local_menu_Brunch;
function render_controls_Brunch(self) {
    return React.createElement("div", { className: "control" },
        self.props.allow_maximisation && self.props.set_size ? React.createElement("a", { className: `"brunch button button--toggle ${self.props.size != 'preview' ? 'button--toggle--open' : ''}`, onClick: () => {
                set_size_Brunch(self, self.props.size == "preview" ? "large" : "preview");
            } }) : null,
        self.props.allow_fullscreen && self.props.set_size ? React.createElement("a", { className: "brunch button button--fullscreen", onClick: () => set_size_Brunch(self, self.props.size == "fullscreen" ? "large" : "fullscreen") }) : null,
        Permissions.can_delete_Brunch(self.props.current_User) && self.props.size == "fullscreen" ? React.createElement("a", { className: "button button--delete", onClick: () => confirm(i18next.t('Are you sure?')) &&
                Api.delete_Brunch(self.props.entity).then(() => self.props.force_reload(() => self.props.pop())) }) : null,
        self.props.size == "fullscreen" && self.props.pages_count > 0 ? React.createElement("a", { className: "brunch button button--close", onClick: () => self.props.pop() }) : null,
...
exports.render_controls_Brunch = render_controls_Brunch;
function render_content_Brunch(self) {
    let actions = [
    ...
    let content = Permissions.can_view_Brunch(self.props.current_User) ?
...
exports.render_content_Brunch = render_content_Brunch;
function render_Brunch_Description_minimised(self) {
    return !Permissions.can_view_Brunch_Description(self.props.current_User) ? null : React.createElement("div", { className: "model__attribute description" },
        React.createElement("label", { className: "attribute-label attribute-label-description" }, i18next.t(`Brunch:Description`, { context: self.props.inline ? "inline" : "" })),
        React.createElement("div", { className: "model__attribute-content" }, Components.String(self.props.is_editable && Permissions.can_edit_Brunch(self.props.current_User) && Permissions.can_edit_Brunch_Description(self.props.current_User), self.props.mode, () => self.props.entity.Description, v => self.props.set_entity(Object.assign({}, self.props.entity, { Description: v })))));
}
exports.render_Brunch_Description_minimised = render_Brunch_Description_minimised;
function render_Brunch_Description_maximised(self) {
    return !Permissions.can_view_Brunch_Description(self.props.current_User) ? null : React.createElement("div", { className: "model__attribute description" },
        React.createElement("label", { className: "attribute-label attribute-label-description" }, i18next.t(`Brunch:Description`, { context: self.props.inline ? "inline" : "" })),
        React.createElement("div", { className: "model__attribute-content" }, Components.String(self.props.is_editable && Permissions.can_edit_Brunch(self.props.current_User) && Permissions.can_edit_Brunch_Description(self.props.current_User), self.props.mode, () => self.props.entity.Description, v => self.props.set_entity(Object.assign({}, self.props.entity, { Description: v })))));
}
exports.render_Brunch_Description_maximised = render_Brunch_Description_maximised;
function render_preview_Brunch(self) {
    let attributes = null;
    if (self.props.mode == "view" || !Permissions.can_edit_Brunch(self.props.current_User))
        attributes = (React.createElement("div", { className: "model__attributes" }, render_Brunch_Description_minimised(self)));
    else
        attributes = render_editable_attributes_minimised_Brunch(self);
    return (React.createElement("div", { className: "block" }, attributes));
}
exports.render_preview_Brunch = render_preview_Brunch;
function render_large_Brunch(self) {
    let state = self.state();
    let attributes = null;
    if (self.props.mode == "view" || !Permissions.can_edit_Brunch(self.props.current_User))
        attributes = (React.createElement("div", { className: "model__attributes" }, render_Brunch_Description_maximised(self)));
    else
...
exports.render_large_Brunch = render_large_Brunch;
function render_Brunch_Cuisine_Meal(self, context) {
    if ((context == "default" && self.props.shown_relation != "all" && self.props.shown_relation != "Cuisine_Meal") || !Permissions.can_view_Cuisine(self.props.current_User))
        return null;
    let state = self.state();
    return React.createElement("div", null, List.render_relation("brunch_cuisine_meal", "Meal", "Cuisine", "Cuisines", self.props.nesting_depth > 0, false, false, false)(state.Cuisine != "loading" ?
        state.Cuisine.IdsInServerOrder.map(id => state.Cuisine != "loading" && state.Cuisine.Items.get(id)) :
        state.Cuisine, Brunch_Cuisine_Meal_page_index(self), Brunch_Cuisine_Meal_num_pages(self), new_page_index => {
        let state = self.state();
        state.Cuisine != "loading" &&
            self.setState(Object.assign({}, self.state(), { update_count: self.state().update_count + 1, Cuisine: Object.assign({}, state.Cuisine, { PageIndex: new_page_index }) }), () => load_relation_Brunch_Cuisine_Meal(self, false, self.props.current_User));
    }, (i, _) => {
        ...
        return React.createElement("div", { key: i_id, className: `model-nested__item ${i.size != "preview" ? "model-nested__item--open" : ""}
            ...
            React.createElement("div", { key: i_id }, CuisineViews.Cuisine(Object.assign({}, self.props, { entity: i.element, inline: false, nesting_depth: self.props.nesting_depth + 1, size: i.size, allow_maximisation: true, allow_fullscreen: true, mode: self.props.mode == "edit" && (Permissions.can_edit_Cuisine_Meal(self.props.current_User)
                    ...
                    null
                    :
                        () => confirm(i18next.t('Are you sure?')) && Api.unlink_Cuisine_Cuisine_Meals(i.element, self.props.entity).then(() => load_relation_Brunch_Cuisine_Meal(self, false, self.props.current_User)) }))));
...
exports.render_Brunch_Cuisine_Meal = render_Brunch_Cuisine_Meal;
function render_Brunch_Meal_Recipe(self, context) {
    if ((context == "default" && self.props.shown_relation != "all" && self.props.shown_relation != "Meal_Recipe") || !Permissions.can_view_Recipe(self.props.current_User))
        return null;
    let state = self.state();
    return React.createElement("div", null, List.render_relation("brunch_meal_recipe", "Meal", "Recipe", "Recipes", self.props.nesting_depth > 0, false, false, false)(state.Recipe != "loading" ?
        state.Recipe.IdsInServerOrder.map(id => state.Recipe != "loading" && state.Recipe.Items.get(id)) :
        state.Recipe, Brunch_Meal_Recipe_page_index(self), Brunch_Meal_Recipe_num_pages(self), new_page_index => {
        let state = self.state();
        state.Recipe != "loading" &&
            self.setState(Object.assign({}, self.state(), { update_count: self.state().update_count + 1, Recipe: Object.assign({}, state.Recipe, { PageIndex: new_page_index }) }), () => load_relation_Brunch_Meal_Recipe(self, false, self.props.current_User));
    }, (i, _) => {
        let i_id = i.element.Id;
        let state = self.state();
        return React.createElement("div", { key: i_id, className: `model-nested__item ${i.size != "preview" ? "model-nested__item--open" : ""}
            ...
            React.createElement("div", { key: i_id }, RecipeViews.Recipe(Object.assign({}, self.props, { entity: i.element, inline: false, nesting_depth: self.props.nesting_depth + 1, size: i.size, allow_maximisation: true, allow_fullscreen: true, mode: self.props.mode == "edit" && (Permissions.can_edit_Meal_Recipe(self.props.current_User)
                    ...
                    null
                    :
                        () => confirm(i18next.t('Are you sure?')) && Api.unlink_Meal_Meal_Recipes(self.props.entity, i.element).then(() => load_relation_Brunch_Meal_Recipe(self, false, self.props.current_User)) }))));
    }, () => React.createElement("div", null,
...
exports.render_Brunch_Meal_Recipe = render_Brunch_Meal_Recipe;
function render_relations_Brunch(self) {
    return React.createElement("div", { className: "relations" }, render_Brunch_Meal_Recipe(self, "default"));
}
exports.render_relations_Brunch = render_relations_Brunch;
function render_add_existing_Brunch_Cuisine_Meal(self) {
    let state = self.state();
...
exports.render_add_existing_Brunch_Cuisine_Meal = render_add_existing_Brunch_Cuisine_Meal;
function render_add_existing_Brunch_Meal_Recipe(self) {
    let state = self.state();
    return self.props.mode == "edit" ?
...
exports.render_add_existing_Brunch_Meal_Recipe = render_add_existing_Brunch_Meal_Recipe;
function render_new_Brunch_Cuisine_Meal(self) {
    let state = self.state();
    return self.props.mode == "edit" ?
                    ...
                    React.createElement("div", { className: "overlay__item overlay__item--new" },
                        React.createElement("div", { className: "new-asian" },
                            React.createElement("button", { disabled: state.Cuisine == "loading" ? true : state.Cuisine.TotalCount >= 1, className: "new-asian button button--new", onClick: () => Api.create_linked_Meal_Cuisine_Meals_Asian(self.props.entity).then(e => {
                                    e.length > 0 &&
                                        Api.update_Asian(Object.assign({}, e[0], { Kind: "Asian", Description: "" })).then(() => load_relation_Brunch_Cuisine_Meal(self, true, self.props.current_User, () => self.setState(Object.assign({}, self.state(), { add_step_Cuisine: "closed" }))));
                        ...
                        React.createElement("div", { className: "new-mediterranean" },
                            React.createElement("button", { disabled: state.Cuisine == "loading" ? true : state.Cuisine.TotalCount >= 1, className: "new-mediterranean button button--new", onClick: () => Api.create_linked_Meal_Cuisine_Meals_Mediterranean(self.props.entity).then(e => {
                                    e.length > 0 &&
                                        Api.update_Mediterranean(Object.assign({}, e[0], { Kind: "Mediterranean", Description: "" })).then(() => load_relation_Brunch_Cuisine_Meal(self, true, self.props.current_User, () => self.setState(Object.assign({}, self.state(), { add_step_Cuisine: "closed" }))));
                        ...
                        React.createElement("div", { className: "new-grill" },
                            React.createElement("button", { disabled: state.Cuisine == "loading" ? true : state.Cuisine.TotalCount >= 1, className: "new-grill button button--new", onClick: () => Api.create_linked_Meal_Cuisine_Meals_Grill(self.props.entity).then(e => {
                                    e.length > 0 &&
                                        Api.update_Grill(Object.assign({}, e[0], { Kind: "Grill", Description: "" })).then(() => load_relation_Brunch_Cuisine_Meal(self, true, self.props.current_User, () => self.setState(Object.assign({}, self.state(), { add_step_Cuisine: "closed" }))));
...
exports.render_new_Brunch_Cuisine_Meal = render_new_Brunch_Cuisine_Meal;
function render_new_Brunch_Meal_Recipe(self) {
    let state = self.state();
    return self.props.mode == "edit" ?
        React.createElement("div", { className: "button__actions" },
            React.createElement("div", { className: "new-recipe" },
                React.createElement("button", { className: "new-recipe button button--new", onClick: () => Api.create_linked_Meal_Meal_Recipes_Recipe(self.props.entity).then(e => {
                        e.length > 0 &&
                            Api.update_Recipe(Object.assign({}, e[0], { Name: "", Ingredients: "", Description: "", Picture: "" })).then(() => load_relation_Brunch_Meal_Recipe(self, true, self.props.current_User, () => self.setState(Object.assign({}, self.state(), { add_step_Recipe: "closed" }))));
                    }) }, i18next.t('Create new Recipe'))))
        :
            null;
}
exports.render_new_Brunch_Meal_Recipe = render_new_Brunch_Meal_Recipe;
function render_saving_animations_Brunch(self) {
...
exports.render_saving_animations_Brunch = render_saving_animations_Brunch;
class BrunchComponent extends React.Component {
    ...
    render() {
        ...
        return React.createElement("div", { id: `Brunch_${this.props.entity.Id.toString()}_${this.state.update_count}`, className: `model brunch` },
...
exports.Brunch = (props) => React.createElement(BrunchComponent, Object.assign({}, props));
exports.Brunch_to_page = (id) => {
    ...
    return Utils.scene_to_page(can_edit, exports.Brunch, Api.get_Brunch(id), Api.update_Brunch, "Brunch", "Brunch", `/Brunches/${id}`);
};
exports.Brunch_to = (id, target_element_id, current_User) => {
    Utils.render_page_manager(target_element_id, exports.Brunch_to_page(id), current_User);
};
