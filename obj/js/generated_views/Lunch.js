...
exports.Lunch_Cuisine_Meal_can_create = Lunch_Cuisine_Meal_can_create;
...
function Lunch_Cuisine_Meal_can_delete(self) {
    let state = self.state();
    return state.Cuisine == "loading" ? false : state.Cuisine.CanDelete;
}
exports.Lunch_Cuisine_Meal_can_delete = Lunch_Cuisine_Meal_can_delete;
...
function Lunch_Cuisine_Meal_page_index(self) {
    let state = self.state();
    return state.Cuisine == "loading" ? 0 : state.Cuisine.PageIndex;
}
exports.Lunch_Cuisine_Meal_page_index = Lunch_Cuisine_Meal_page_index;
...
function Lunch_Cuisine_Meal_page_size(self) {
    let state = self.state();
    return state.Cuisine == "loading" ? 25 : state.Cuisine.PageSize;
}
exports.Lunch_Cuisine_Meal_page_size = Lunch_Cuisine_Meal_page_size;
...
function Lunch_Cuisine_Meal_search_query(self) {
    let state = self.state();
    return state.Cuisine == "loading" ? null : state.Cuisine.SearchQuery;
}
exports.Lunch_Cuisine_Meal_search_query = Lunch_Cuisine_Meal_search_query;
...
function Lunch_Cuisine_Meal_num_pages(self) {
    let state = self.state();
    return state.Cuisine == "loading" ? 1 : state.Cuisine.NumPages;
}
exports.Lunch_Cuisine_Meal_num_pages = Lunch_Cuisine_Meal_num_pages;
...
function load_relation_Lunch_Cuisine_Meal(self, force_first_page, current_User, callback) {
    let state = self.state();
    ...
    Permissions.can_view_Cuisine(current_User) ?
        prelude(() => Api.get_Meal_Cuisine_Meals(self.props.entity, Lunch_Cuisine_Meal_page_index(self), Lunch_Cuisine_Meal_page_size(self), Lunch_Cuisine_Meal_search_query(self)).then(Cuisines => self.setState(Object.assign({}, self.state(), { update_count: self.state().update_count + 1, Cuisine: Utils.raw_page_to_paginated_items((i, i_just_created) => {
                let state = self.state();
                return {
                    element: i,
...
exports.load_relation_Lunch_Cuisine_Meal = load_relation_Lunch_Cuisine_Meal;
function load_relation_Lunch_Meal_Recipe(self, force_first_page, current_User, callback) {
    let state = self.state();
...
function load_relations_Lunch(self, current_User, callback) {
    load_relation_Lunch_Meal_Recipe(self, false, self.props.current_User, () => load_relation_Lunch_Cuisine_Meal(self, false, self.props.current_User, () => callback && callback()));
}
...
function render_Lunch_Description_editable_minimised(self) {
    if (!Permissions.can_edit_Lunch(self.props.current_User))
        return render_Lunch_Description_minimised(self);
    else
        return !Permissions.can_view_Lunch_Description(self.props.current_User) ? React.createElement("div", null) :
        ...
        React.createElement("div", { className: "local_menu_entries" },
            ...
            !Permissions.can_view_Recipe(self.props.current_User) ? null :
                React.createElement("div", { key: "Meal_Recipe", className: `local_menu_entry${self.props.shown_relation == "Meal_Recipe" ? " local_menu_entry--active" : ""}` },
                    React.createElement("a", { onClick: () => load_relation_Lunch_Meal_Recipe(self, false, self.props.current_User, () => self.props.set_shown_relation("Meal_Recipe")) }, i18next.t('Meal_Recipes')))));
}
...
function render_controls_Lunch(self) {
    return React.createElement("div", { className: "control" },
        ...
        Permissions.can_delete_Lunch(self.props.current_User) && self.props.size == "fullscreen" ? React.createElement("a", { className: "button button--delete", onClick: () => confirm(i18next.t('Are you sure?')) &&
...
function render_content_Lunch(self) {
    ...
    let content = Permissions.can_view_Lunch(self.props.current_User) ?
...
function render_Lunch_Description_minimised(self) {
    return !Permissions.can_view_Lunch_Description(self.props.current_User) ? null : React.createElement("div", { className: "model__attribute description" },
        React.createElement("label", { className: "attribute-label attribute-label-description" }, i18next.t(`Lunch:Description`, { context: self.props.inline ? "inline" : "" })),
        React.createElement("div", { className: "model__attribute-content" }, Components.String(self.props.is_editable && Permissions.can_edit_Lunch(self.props.current_User) && Permissions.can_edit_Lunch_Description(self.props.current_User), self.props.mode, () => self.props.entity.Description, v => self.props.set_entity(Object.assign({}, self.props.entity, { Description: v })))));
}
...
function render_preview_Lunch(self) {
    let attributes = null;
    if (self.props.mode == "view" || !Permissions.can_edit_Lunch(self.props.current_User))
...
function render_Lunch_Cuisine_Meal(self, context) {
    if ((context == "default" && self.props.shown_relation != "all" && self.props.shown_relation != "Cuisine_Meal") || !Permissions.can_view_Cuisine(self.props.current_User))
        return null;
    let state = self.state();
    return React.createElement("div", null, List.render_relation("lunch_cuisine_meal", "Meal", "Cuisine", "Cuisines", self.props.nesting_depth > 0, false, false, false)(state.Cuisine != "loading" ?
        state.Cuisine.IdsInServerOrder.map(id => state.Cuisine != "loading" && state.Cuisine.Items.get(id)) :
        state.Cuisine, Lunch_Cuisine_Meal_page_index(self), Lunch_Cuisine_Meal_num_pages(self), new_page_index => {
        let state = self.state();
        state.Cuisine != "loading" &&
            self.setState(Object.assign({}, self.state(), { update_count: self.state().update_count + 1, Cuisine: Object.assign({}, state.Cuisine, { PageIndex: new_page_index }) }), () => load_relation_Lunch_Cuisine_Meal(self, false, self.props.current_User));
    }, (i, _) => {
        ...
        return React.createElement("div", { key: i_id, className: `model-nested__item ${i.size != "preview" ? "model-nested__item--open" : ""}
            ...
            React.createElement("div", { key: i_id }, CuisineViews.Cuisine(Object.assign({}, self.props, { entity: i.element, inline: false, nesting_depth: self.props.nesting_depth + 1, size: i.size, allow_maximisation: true, allow_fullscreen: true, mode: self.props.mode == "edit" && (Permissions.can_edit_Cuisine_Meal(self.props.current_User)
                    ...
                    null
                    :
                        () => confirm(i18next.t('Are you sure?')) && Api.unlink_Cuisine_Cuisine_Meals(i.element, self.props.entity).then(() => load_relation_Lunch_Cuisine_Meal(self, false, self.props.current_User)) }))));
    }, () => React.createElement("div", null,
        Permissions.can_create_Cuisine(self.props.current_User) && Permissions.can_create_Cuisine_Meal(self.props.current_User) && Lunch_Cuisine_Meal_can_create(self) ? render_new_Lunch_Cuisine_Meal(self) : null,
        Permissions.can_create_Cuisine_Meal(self.props.current_User) ? render_add_existing_Lunch_Cuisine_Meal(self) : null)));
}
exports.render_Lunch_Cuisine_Meal = render_Lunch_Cuisine_Meal;
function render_Lunch_Meal_Recipe(self, context) {
    ...
    return React.createElement("div", null, List.render_relation("lunch_meal_recipe", "Meal", "Recipe", "Recipes", self.props.nesting_depth > 0, false, false, false)(state.Recipe != "loading" ?
        ...
        state.Recipe != "loading" &&
            self.setState(Object.assign({}, self.state(), { update_count: self.state().update_count + 1, Recipe: Object.assign({}, state.Recipe, { PageIndex: new_page_index }) }), () => load_relation_Lunch_Meal_Recipe(self, false, self.props.current_User));
    }, (i, _) => {
        let i_id = i.element.Id;
        let state = self.state();
        return React.createElement("div", { key: i_id, className: `model-nested__item ${i.size != "preview" ? "model-nested__item--open" : ""}
            ...
            React.createElement("div", { key: i_id }, RecipeViews.Recipe(Object.assign({}, self.props, { entity: i.element, inline: false, nesting_depth: self.props.nesting_depth + 1, size: i.size, allow_maximisation: true, allow_fullscreen: true, mode: self.props.mode == "edit" && (Permissions.can_edit_Meal_Recipe(self.props.current_User)
                    ...
                    null
                    :
                        () => confirm(i18next.t('Are you sure?')) && Api.unlink_Meal_Meal_Recipes(self.props.entity, i.element).then(() => load_relation_Lunch_Meal_Recipe(self, false, self.props.current_User)) }))));
    }, () => React.createElement("div", null,
        Permissions.can_create_Recipe(self.props.current_User) && Permissions.can_create_Meal_Recipe(self.props.current_User) && Lunch_Meal_Recipe_can_create(self) ? render_new_Lunch_Meal_Recipe(self) : null,
        Permissions.can_create_Meal_Recipe(self.props.current_User) ? render_add_existing_Lunch_Meal_Recipe(self) : null)));
}
...
function render_add_existing_Lunch_Cuisine_Meal(self) {
    let state = self.state();
...
exports.render_add_existing_Lunch_Cuisine_Meal = render_add_existing_Lunch_Cuisine_Meal;
...
function render_new_Lunch_Cuisine_Meal(self) {
    let state = self.state();
    return self.props.mode == "edit" ?
                    ...
                    React.createElement("div", { className: "overlay__item overlay__item--new" },
                        React.createElement("div", { className: "new-asian" },
                            React.createElement("button", { disabled: state.Cuisine == "loading" ? true : state.Cuisine.TotalCount >= 1, className: "new-asian button button--new", onClick: () => Api.create_linked_Meal_Cuisine_Meals_Asian(self.props.entity).then(e => {
                                    e.length > 0 &&
                                        Api.update_Asian(Object.assign({}, e[0], { Kind: "Asian", Description: "" })).then(() => load_relation_Lunch_Cuisine_Meal(self, true, self.props.current_User, () => self.setState(Object.assign({}, self.state(), { add_step_Cuisine: "closed" }))));
                        ...
                        React.createElement("div", { className: "new-mediterranean" },
                            React.createElement("button", { disabled: state.Cuisine == "loading" ? true : state.Cuisine.TotalCount >= 1, className: "new-mediterranean button button--new", onClick: () => Api.create_linked_Meal_Cuisine_Meals_Mediterranean(self.props.entity).then(e => {
                                    e.length > 0 &&
                                        Api.update_Mediterranean(Object.assign({}, e[0], { Kind: "Mediterranean", Description: "" })).then(() => load_relation_Lunch_Cuisine_Meal(self, true, self.props.current_User, () => self.setState(Object.assign({}, self.state(), { add_step_Cuisine: "closed" }))));
                        ...
                        React.createElement("div", { className: "new-grill" },
                            React.createElement("button", { disabled: state.Cuisine == "loading" ? true : state.Cuisine.TotalCount >= 1, className: "new-grill button button--new", onClick: () => Api.create_linked_Meal_Cuisine_Meals_Grill(self.props.entity).then(e => {
                                    e.length > 0 &&
                                        Api.update_Grill(Object.assign({}, e[0], { Kind: "Grill", Description: "" })).then(() => load_relation_Lunch_Cuisine_Meal(self, true, self.props.current_User, () => self.setState(Object.assign({}, self.state(), { add_step_Cuisine: "closed" }))));
...
exports.render_new_Lunch_Cuisine_Meal = render_new_Lunch_Cuisine_Meal;
        ...
        React.createElement("div", { className: "button__actions" },
            React.createElement("div", { className: "new-recipe" },
                React.createElement("button", { className: "new-recipe button button--new", onClick: () => Api.create_linked_Meal_Meal_Recipes_Recipe(self.props.entity).then(e => {
                        e.length > 0 &&
                            Api.update_Recipe(Object.assign({}, e[0], { Name: "", Ingredients: "", Description: "", Picture: "" })).then(() => load_relation_Lunch_Meal_Recipe(self, true, self.props.current_User, () => self.setState(Object.assign({}, self.state(), { add_step_Recipe: "closed" }))));
...
class LunchComponent extends React.Component {
    ...
    componentWillReceiveProps(new_props) {
        ...
        if (new_props.mode != this.props.mode || (new_props.size != this.props.size && (new_props.size == "large" || new_props.size == "fullscreen")) ||
            ...
            load_relations_Lunch(this.get_self(), new_props.current_User);
        }
    }
    componentWillMount() {
        ...
        if (this.props.size != "preview") {
            load_relations_Lunch(this.get_self(), this.props.current_User);
        }
    ...
    render() {
        if (this.props.size == "breadcrumb") {
            return Permissions.can_view_Lunch(this.props.current_User) ?
...
exports.Lunch_to_page = (id) => {
    let can_edit = Utils.any_of([Permissions.can_edit_Lunch, Permissions.can_edit_Cuisine_Meal, Permissions.can_edit_Meal_Recipe, Permissions.can_edit_Cuisine, Permissions.can_edit_Recipe]);
    return Utils.scene_to_page(can_edit, exports.Lunch, Api.get_Lunch(id), Api.update_Lunch, "Lunch", "Lunch", `/Lunches/${id}`);
};
exports.Lunch_to = (id, target_element_id, current_User) => {
    Utils.render_page_manager(target_element_id, exports.Lunch_to_page(id), current_User);
};
